...
# VERL/vLLM and GPU 7 runs two independent visual-tool service processes.
...
# Keep the full n=16 sampling budget, but expose early checkpoints for
# evaluation instead of waiting roughly half a day for step 20.
