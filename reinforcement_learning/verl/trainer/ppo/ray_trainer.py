        ...
        for test_data in self.val_dataloader:
            ...
            if self.config.actor_rollout_ref.rollout.agent.activate_agent:
                ...
                if "index" in test_batch.non_tensor_batch:
                    test_gen_batch.non_tensor_batch["index"] = test_batch.non_tensor_batch.get("index")
                if "extra_info" in test_batch.non_tensor_batch:
                    test_gen_batch.non_tensor_batch["extra_info"] = test_batch.non_tensor_batch.get("extra_info")
            ...
            for batch_dict in self.train_dataloader:
                ...
                if self.config.actor_rollout_ref.rollout.agent.activate_agent:
                    ...
                    if "index" in batch.non_tensor_batch:
                        gen_batch.non_tensor_batch["index"] = batch.non_tensor_batch.get("index")
